                ...
                <nav aria-label="breadcrumb">
                    <ol
                        ...
                        <li class="breadcrumb-item text-sm text-dark active"
                            aria-current="page">Kriteria 1</li>
                    </ol>
                </nav>
            </div>
        </nav>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div
                            ...
                            @if (auth()->user()->role->role_kode === 'A1')
    <a href="{{ route('kriteria.1.input') }}" class="btn btn-sm btn-success">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (userRole === 'A1') {  // Check role A1 untuk tombol Edit dan Hapus
        buttons += `
