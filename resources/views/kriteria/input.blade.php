                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <label for="pendukung_pelaksanaan" class="form-label">Pendukung Pelaksanaan
                                            (Upload File)</label>
                                        <div class="file-input-wrapper">
                                            <input type="file" name="pendukung_pelaksanaan"
                                            ...
                                            <div id="filePreview2" class="file-preview">
                                                ...
                                                <img id="imagePreview2" src="#" alt="Image Preview"
                                                    style="display: none;">
                                                <i id="pdfIcon2" class="fa fa-file-pdf-o"
                                        ...
                                        <div class="file-input-wrapper">
                                            ...
                                            <div id="filePreview3" class="file-preview">
                                                ...
                                                <img id="imagePreview3" src="#" alt="Image Preview"
                                                    style="display: none;">
                                                <i id="pdfIcon3" class="fa fa-file-pdf-o"
                                                    style="display: none;"></i>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <label for="pendukung_pengendalian" class="form-label">Pendukung Pengendalian
                                            (Upload File)</label>
                                        <div class="file-input-wrapper">
                                            <input type="file" name="pendukung_pengendalian"
                                            ...
                                            <div id="filePreview4" class="file-preview">
                                                ...
                                                <img id="imagePreview4" src="#" alt="Image Preview"
                                                    style="display: none;">
                                                <i id="pdfIcon4" class="fa fa-file-pdf-o"
                                                    style="display: none;"></i>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-9 mb-3">
                                        ...
                                        <textarea name="peningkatan" id="peningkatan" rows="3"
                                            class="form-control @error('peningkatan') is-invalid @enderror" placeholder="Masukkan peningkatan">{{ old('peningkatan') }}</textarea>
                                        @error('peningkatan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label for="pendukung_peningkatan" class="form-label">Pendukung Peningkatan
                                            (Upload File)</label>
                                        <div class="file-input-wrapper">
                                            <input type="file" name="pendukung_peningkatan"
                                            ...
                                            <div id="filePreview5" class="file-preview">
                                                ...
                                                <img id="imagePreview5" src="#" alt="Image Preview"
                                                    style="display: none;">
                                                <i id="pdfIcon5" class="fa fa-file-pdf-o"
                                                    style="display: none;"></i>
                                            </div>
