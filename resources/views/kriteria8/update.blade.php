...
<body class="g-sidenav-show bg-gray-100">
                ...
                <div class="col-12">
                    <div class="card border shadow-xs mb-4">
                        <div class="custom-form-section p-4">
                            <h4 class="form-title text-right mb-4">Edit Kriteria 8 - Pengabdian Kepada Masyarakat</h4>
                            ...
                            <form method="POST" action="{{ route('kriteria8.update', $detail->id_detail_kriteria) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
    ...
    <button type="submit" name="status" value="submitted" class="btn btn-primary px-4">Submit</button>
                                    <a href="{{ route('kriteria8.index') }}" class="btn btn-danger px-4 me-2">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
