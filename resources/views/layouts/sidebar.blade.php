...
<style>
  ...
  .sidenav {
      width: 250px;
      background-color: #1d4ed8; /* Warna latar belakang */
      color: white;
      height: 100vh;
      position: fixed;
  }
  ...
  .nav-link.active {
      background-color: #1e3a8a; /* Warna latar belakang aktif */
      border-left: 4px solid #ffffff; /* Garis di sebelah kiri */
  }
  .icon {
      margin-right: 10px;
  }
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand d-flex align-items-center m-0" href="https://demos.creative-tim.com/corporate-ui-dashboard/pages/dashboard.html" target="_blank">
        <span class="font-weight-bold text-lg">AKREDITASI D4 SIB</span>
      </a>
    </div>
    <div class="collapse navbar-collapse px-4 w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link d-flex align-items-center justify-content-between w-100"
            ...
            <div class="collapse ms-4" id="submenuKriteria">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('kriteria6.index')}}">Kriteria 6</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('kriteria7.index')}}">Kriteria 7</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('kriteria8.index')}}">Kriteria 8</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('kriteria9.index')}}">Kriteria 9</a>
                  </li>
              </ul>
            </div>
          </li>
  ...
  <script>
    // Menambahkan event listener pada setiap link menu
