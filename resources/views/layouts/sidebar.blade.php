            ...
            <div class="collapse ms-4" id="submenuKriteria">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="pages/kriteria2.html">Kriteria 7</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/kriteria2.html">Kriteria 8</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/kriteria2.html">Kriteria 9</a>
                  </li>
              </ul>
            </div>
          </li>
