...
<body class="g-sidenav-show bg-gray-100">
            ...
            <div class="container-fluid py-1 px-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-1 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Kriteria 6</li>
                    </ol>
                </nav>
            </div>
        </nav>
                ...
                <div class="col-12">
                    <div class="card border shadow-xs mb-4">
                        <div class="custom-form-section p-4">
                            <h4 class="form-title text-right mb-4">Kriteria 6 - VMTS</h4>
                            <form method="POST" action="{{ route('kriteria6.store') }}" enctype="multipart/form-data">
                                @csrf
                                <!-- Hidden status field -->
    ...
    <a href="{{ route('kriteria6.index') }}" class="btn btn-danger px-4">Cancel</a>
</div>
