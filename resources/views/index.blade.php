...
<body id="top" class="landing-page sidebar-collapse">
  <!-- Navbar -->
          ...
          <div class="col-md-4">
            <div class="card card-profile card-plain">
              ...
              <div class="card-body">
                <a href="#paper-kit">
                  <div class="author">
                    <h4 class="card-title">Muhammad Rosyid</h4>
          ...
          <div class="col-md-4">
            <div class="card card-profile card-plain">
              ...
              <div class="card-body">
                <a href="#paper-kit">
                  <div class="author">
                    <h4 class="card-title">Anak Agung</h4>
          ...
          <div class="col-md-4">
            <div class="card card-profile card-plain">
              ...
              <div class="card-body">
                <a href="#paper-kit">
                  <div class="author">
                    <h4 class="card-title">Muhammad Arif</h4>
          ...
          <div class="col-md-4">
            <div class="card card-profile card-plain">
              ...
              <div class="card-body">
                <a href="#paper-kit">
                  <div class="author">
                    <h4 class="card-title">Belqis Ivana</h4>
                    <h6 class="card-category">Developer</h6>
                  </div>
                </a>
              </div>
          ...
          <div class="col-md-4">
            <div class="card card-profile card-plain">
              ...
              <div class="card-body">
                <a href="#paper-kit">
                  <div class="author">
                    <h4 class="card-title">Dewi Sulistyowati</h4>
                    <h6 class="card-category">Developer</h6>
                  </div>
                </a>
              </div>
      ...
      <div class="container d-flex justify-content-center align-items-center">
        <div class="credits">
          <span class="copyright" style="color:white;">
            ...
            </script>, made with <i class="fa fa-heart heart"></i> by Group 4 SIB 2D
          </span>
        </div>
      </div>
    </div>
