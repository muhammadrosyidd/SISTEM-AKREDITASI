...
class Kriteria9Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $page = (object) [
            'title' => 'Kriteria 9 - Statuta Polinema',
        ];

        $activeMenu = 'kriteria';
        $activeSubmenu = 'kriteria9';

        return view('kriteria9.index', [
    ...
    public function list(Request $request)
{
    ...
    $details = DetailKriteriaModel::with([
        ...
        ->whereIn('id_kriteria', [9]);

    if (!in_array($userRole, ['A9'])) {
     ...
     public function store(Request $request)
{
    ...
    $id_kriteria = 9; // karena ini store untuk Kriteria 1
    ...
    return redirect()->route('kriteria9.index')->with('success', 'Data berhasil disimpan');
}
    ...
    private function getOrCreateAvailableBatch($id_kriteria)
{
    ...
    public function edit($id)
    {
        ...
        return view('kriteria9.update', compact('detail'));
    }
    ...
    public function update(Request $request, $id)
{
    ...
    return redirect()->route('kriteria9.index')->with('success', 'Data berhasil diupdate');
}
...
public function previewpdf($id)
{
    ...
    $pdf = Pdf::loadView('kriteria9.preview-pdf', $data);
...
public function destroy($id)
{
    ...
    return redirect()->route('kriteria9.index')->with('success', 'Data berhasil dihapus');
}
