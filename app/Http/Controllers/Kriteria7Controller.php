...
class Kriteria7Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $page = (object) [
            'title' => 'Kriteria 7 - Statuta Polinema',
        ];
    ...
    public function list(Request $request)
    {
        ...
        $details = DetailKriteriaModel::with('kriteria:id_kriteria,nama_kriteria')
            ...
            ->whereIn('id_kriteria',[7]);

        if (!in_array($userRole, ['A7'])) {
     ...
     public function store(Request $request)
{
    ...
    $id_kriteria = 7; // karena ini store untuk Kriteria 1
...
$nomorBatch = $lastId + 1;
    ...
    public function edit($id)
    {
        ...
        return view('kriteria7.update', compact('detail'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('kriteria7.index')->with('success', 'Data berhasil diupdate');
    }
...
public function previewpdf($id)
{
    ...
    $pdf = Pdf::loadView('kriteria7.preview-pdf', $data);
...
public function destroy($id)
{
    ...
    return redirect()->route('kriteria7.index')->with('success', 'Data berhasil dihapus');
}
