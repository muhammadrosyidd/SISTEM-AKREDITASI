...
class Kriteria2Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $page = (object) [
            'title' => 'Kriteria 2 - Statuta Polinema',
        ];
    ...
    $status = $request->input('status');
        ...
        return redirect()->route('kriteria2.index')->with('success', 'Data berhasil disimpan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('kriteria2.update', compact('detail'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('kriteria2.index')->with('success', 'Data berhasil diupdate');
    }
...
public function previewpdf($id)
{
    ...
    $pdf = Pdf::loadView('kriteria2.preview-pdf', $data);
...
public function destroy($id)
{
    ...
    return redirect()->route('kriteria2.index')->with('success', 'Data berhasil dihapus');
}
