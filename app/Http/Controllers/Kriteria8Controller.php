...
class Kriteria8Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $page = (object) [
            'title' => 'Kriteria 8 - Statuta Polinema',
        ];

        $activeMenu = 'kriteria';
        $activeSubmenu = 'kriteria8';

        return view('kriteria8.index', [
    ...
    public function list(Request $request)
{
    ...
    $details = DetailKriteriaModel::with([
        ...
        ->whereIn('id_kriteria', [8]);

    if (!in_array($userRole, ['A8'])) {
     ...
     public function store(Request $request)
{
    ...
    $id_kriteria = 8; // karena ini store untuk Kriteria 1
    ...
    return redirect()->route('kriteria8.index')->with('success', 'Data berhasil disimpan');
}
    ...
    private function getOrCreateAvailableBatch($id_kriteria)
{
    ...
    public function edit($id)
    {
        ...
        return view('kriteria8.update', compact('detail'));
    }
    ...
    public function update(Request $request, $id)
{
    ...
    return redirect()->route('kriteria8.index')->with('success', 'Data berhasil diupdate');
}
...
public function previewpdf($id)
{
    ...
    $pdf = Pdf::loadView('kriteria8.preview-pdf', $data);
...
public function destroy($id)
{
    ...
    return redirect()->route('kriteria8.index')->with('success', 'Data berhasil dihapus');
}
