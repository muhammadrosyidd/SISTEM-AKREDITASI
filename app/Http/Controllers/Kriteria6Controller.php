...
class Kriteria6Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $page = (object) [
            'title' => 'Kriteria 6 - Statuta Polinema',
        ];
    ...
    public function list(Request $request)
{
    ...
    $details = DetailKriteriaModel::with([
        ...
        ->whereIn('id_kriteria', [6]);

    if (!in_array($userRole, ['A6'])) {
     ...
     public function store(Request $request)
{
    ...
    $id_kriteria = 6; // karena ini store untuk Kriteria 1
    ...
    return redirect()->route('kriteria6.index')->with('success', 'Data berhasil disimpan');
}
    ...
    private function getOrCreateAvailableBatch($id_kriteria)
{
    ...
    public function edit($id)
    {
        ...
        return view('kriteria6.update', compact('detail'));
    }
    ...
    public function update(Request $request, $id)
{
    ...
    return redirect()->route('kriteria6.index')->with('success', 'Data berhasil diupdate');
}
...
public function previewpdf($id)
{
    ...
    $pdf = Pdf::loadView('kriteria6.preview-pdf', $data);
...
public function destroy($id)
{
    ...
    return redirect()->route('kriteria6.index')->with('success', 'Data berhasil dihapus');
}
